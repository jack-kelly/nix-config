...
Prefer jj over git.
Prefer leveraging direnv, e.g. `direnv reload` after flake change. It should be assumed loaded prior to harness start, warn if not.
NEVER COMMIT/PUSH CODE OR EXTERNAL RESOURCES WITHOUT EXPLICIT APPROVAL.
